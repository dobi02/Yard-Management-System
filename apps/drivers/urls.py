...
from .views import DriversView, DriverDetailView, DriversYardListView, DriversDivisionListView, DriverIdDetailView
from . import views
...
urlpatterns = [
    ...
    path('api/drivers-id/<str:pk>/', DriverIdDetailView.as_view(), name='driver-id-detail'),
